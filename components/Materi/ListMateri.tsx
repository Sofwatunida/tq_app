...
const ListMateri = ({ materiAktif }: Props) => {
  ...
  return (
    <div className="bg-white shadow-lg rounded-2xl overflow-hidden w-full max-h-[600px] overflow-y-auto p-5">
      <h2 className="font-bold text-3xl text-blue-500 mb-3 sticky top-0 bg-white">
      ...
      <ol className="list-decimal pl-6 space-y-2 text-sm sm:text-base">
        {materiAktif.subMateri.map((item) => (
          ...
          >
            <span className="list-item break-words text-lg font-bold">
              {item.judul}
            </span>
