    ...
    flex-col"
      >
        <div className="relative">
          {/* heading text */}
          <h1 className="text-4xl leading-tight sm:text-6xl md:text-7xl lg:text-8xl font-bold text-center text-gray-800">
            Belajar Tajwid Jadi{" "}
            <span className="text-cyan-600">Lebih Mudah</span>
          </h1>
          {/* isinya */}
          <p className="mt-3 text-base sm:text-2xl lg:text-xl leading-8 text-center">
